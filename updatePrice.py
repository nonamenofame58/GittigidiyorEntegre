...
class updatePrice:
    def __init__(self,apiKey = '',sign = '',time = '',productId = '' ,itemId = {''},price = 1.1,cancelBid = False, lang = 'tr',session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.updatePrice(apiKey,sign,time,productId,itemId,price,cancelBid,lang).content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:updatePriceResponse']['return']
