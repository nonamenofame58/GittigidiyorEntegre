...
class updateMarketPrice:
    def __init__(self,apiKey = '',sign = '',time = '',productId = '',marketPrice = '' ,lang = '',session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.updateMarketPrice(apiKey,sign,time,productId,marketPrice,lang).content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:updateMarketPriceResponse']['return']
