...
class getProductsByIds:
    def __init__(self,apiKey = '',sign = '',time = '',productIdList = {'item' : []},itemIdList = {'item' : []},withData = False,lang = 'tr',session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.getProductsByIds(apiKey,sign,time,productIdList,itemIdList,withData,lang).content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:getProductsByIdsResponse']['return']
