...
class cancelSaleAfterEarlyCancellationRequest:
    def __init__(self,apiKey = '',sign = '',time = '',saleCode = '',lang = '',session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.cancelSaleAfterEarlyCancellationRequest(apiKey,sign,time,saleCode,lang).content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:cancelSaleAfterEarlyCancellationRequestResponse']['return']
