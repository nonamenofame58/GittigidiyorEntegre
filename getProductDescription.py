...
class getProductDescription:
    def __init__(self,apiKey = '',sign = '',time = '',productId = '',itemId = '',lang = '' ,session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.getProductDescription(apiKey,sign,time,productId,itemId,lang).content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:getProductDescriptionResponse']['return']
