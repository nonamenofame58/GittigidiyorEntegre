...
class deleteConversation:
    def __init__(self,apiKey = '',sign = '',time = '',deleteConversationRequest = {'conversationId' : '','lang' : ''},session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.deleteConversation(apiKey,sign,time,deleteConversationRequest).content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:deleteConversationResponse']['return']
