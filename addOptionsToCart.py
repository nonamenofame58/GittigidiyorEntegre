...
class addOptionsToCart:
    def __init__(self,apiKey = '',sign = '',time = '',productsOptionFeature = {'productsOptionFeature' : {'productOptions' : {'productOption ' : {'productId' :'','productFeatureType' : {'optionFeatureType' : {'optionId' : '' , 'duration' : ''}}}}}}, lang = 'tr',session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.addOptionsToCart(apiKey,sign,time,productsOptionFeature,lang).content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:addOptionsToCartResponse']['return']
