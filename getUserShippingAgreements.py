...
class getUserShippingAgreements:
    def __init__(self,apiKey = '',sign = '',time = '',lang = '',session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.getUserShippingAgreements(apiKey,sign,time,lang).content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:getUserShippingAgreementsResponse']['return']
