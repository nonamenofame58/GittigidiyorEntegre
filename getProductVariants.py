...
class getProductVariants:
    def __init__(self,apiKey = '',sign = '',time = '',productId = '',itemId = '' ,variantId = 123,variantStockCode = '',lang = '',session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.getProductVariants(apiKey,sign,time,productId,itemId,variantId,variantStockCode,lang).content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:getProductVariantsResponse']['return']
