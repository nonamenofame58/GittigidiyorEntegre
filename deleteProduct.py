...
class deleteProduct:
    def __init__(self,apiKey = '',sign = '',time = '',productIdList = {},itemIdList = {},lang = '' ,session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.deleteProduct(apiKey,sign,time,productIdList,itemIdList,lang).content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:deleteProductResponse']['return']
