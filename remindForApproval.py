...
class remindForApproval:
    def __init__(self,apiKey = '',sign = '',time = '',saleCode = 21321,lang = '',session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.remindForApproval(apiKey,sign,time,saleCode,lang).content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:remindForApprovalResponse']['return']
