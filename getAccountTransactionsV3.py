...
class getAccountTransactionsV3:
    def __init__(self,apiKey = '',sign = '',time = '',startDate = '',endDate = '',startOffSet = 2,rowCount = 2,lang = '',session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.getAccountTransactionsV3(apiKey,sign,time,startDate,endDate,startOffSet,rowCount,lang).content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:getAccountTransactionsV3Response']['return']
