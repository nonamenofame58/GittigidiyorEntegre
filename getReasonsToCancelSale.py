...
class getReasonsToCancelSale:
    def __init__(self,apiKey = '',sign = '',time = '',count = 2,reason = '',lang = '',session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.getReasonsToCancelSale(apiKey,sign,time,count,reason,lang).content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:getReasonsToCancelSaleResponse']['return']
