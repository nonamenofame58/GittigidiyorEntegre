...
class getStockAndPrice:
    def __init__(self,apiKey = '',sign = '',time = '',productIdArray = {'item' : []},itemIdArray = {'item' : []},lang = '' ,session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.getStockAndPrice(apiKey,sign,time,productIdArray,itemIdArray,lang).content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:getStockAndPriceResponse']['return']
