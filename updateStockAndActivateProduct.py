...
class updateStockAndActivateProduct:
    def __init__(self,apiKey = '',sign = '',time = '',productId = 12312,itemId = '',stockId = 2 ,lang = '',session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.updateStockAndActivateProduct(apiKey,sign,time,productId,itemId,stockId,lang).content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:updateStockAndActivateProductResponse']['return']
