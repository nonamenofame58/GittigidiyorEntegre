...
class getNewlyListedProductIdList:
    def __init__(self,apiKey = '',sign = '',time = '',startOffSet = 1,rowCount = 1 ,viaApi = False,session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.getNewlyListedProductIdList(apiKey,sign,time,startOffSet,rowCount,viaApi,lang).content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:getNewlyListedProductIdListResponse']['return']
