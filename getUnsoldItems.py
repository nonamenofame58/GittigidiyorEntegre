...
class getUnsoldItems:
    def __init__(self,apiKey = '',sign = '',time = '',startOffSet = 1,rowCount = 1,withData = False,lang = '',session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.getUnsoldItems(apiKey,sign,time,startOffSet,rowCount,withData,lang).content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:getUnsoldItemsResponse']['return']
