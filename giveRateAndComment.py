...
class giveRateAndComment:
    def __init__(self,apiKey = '',sign = '',time = '',userType = '',productId = 2,rate = 2,comment = '',lang = '',session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.giveRateAndComment(apiKey,sign,time,userType,productId,rate,comment,lang).content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:giveRateAndCommentResponse']['return']
