...
class isDeveloper:
    def __init__(self,nick = '', password = '',lang = '',session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.isDeveloper(nick,password,lang).    content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:isDeveloperResponse']['return']
