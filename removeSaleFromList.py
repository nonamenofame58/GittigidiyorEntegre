...
class removeSaleFromList:
    def __init__(self,apiKey = '',sign = '',time = '',saleCode = '',userType = '',lang = '',session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.removeSaleFromList(apiKey,sign,time,saleCode,userType,lang).content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:removeSaleFromListResponse']['return']
