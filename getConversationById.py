...
class getConversationById:
    def __init__(self,apiKey = '',sign = '',time = '',getConversationByIdRequest = {'conversationId' : '','lang' : ''},session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.getConversationById(apiKey,sign,time,getConversationByIdRequest).content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:getConversationByIdResponse']['return']
