...
class getProduct:
    def __init__(self,apiKey = '',sign = '',time = '',productId = '',itemId = '' ,session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.getProduct(apiKey,sign,time,productId,itemId,lang).content.decode('utf-8'),dict)
                #Parsing...
