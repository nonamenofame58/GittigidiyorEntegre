...
class getItemIdDetails:
    def __init__(self,apiKey = '',sign = '',time = '',productIds = [],lang = '',session = None):
        ...
        with client.settings(raw_response=True):
            try:
                response = helpers.serialize_object(service.getItemIdDetails(apiKey,sign,time,productIds,lang).content.decode('utf-8'),dict)
                #Parsing...
                ...
                jsonList = jsonload['env:Envelope']['env:Body']['ns0:getItemIdDetailsResponse']['return']
